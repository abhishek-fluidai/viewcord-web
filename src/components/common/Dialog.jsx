...
<div id="crypto-modal" tabindex="-1" ariaHidden="true" className="fixed top-1/2 left-10 right-0 z-50 w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-modal md:h-full"
style={{
